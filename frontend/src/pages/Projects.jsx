  ...
  return (
    <div>
      ...
      <div className="py-4 flex gap-4 flex-wrap">
        <button className="w-60 h-40 flex items-center justify-center bg-grayish-blue dark:bg-deep-navy rounded">
          <FaPlus className="text-lg text-black dark:text-dark-text" />
        </button>
        <div className="w-60 h-40 bg-grayish-blue dark:bg-deep-navy rounded overflow-hidden">
